...
return new class extends Migration
{
     ...
     * Цена и старая цена теперь необязательны при создании проекта.
     */
    public function up(): void
    {
        Schema::table('mebel_projects', function (Blueprint $table) {
            $table->decimal('price', 12, 2)->nullable()->comment('Цена проекта')->change();
    ...
    {
        Schema::table('mebel_projects', function (Blueprint $table) {
            $table->decimal('price', 12, 2)->nullable(false)->default(0)->comment('Цена проекта')->change();
